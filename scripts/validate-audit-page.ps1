...
Assert-Contains -PathToCheck $monitoringHtml -Pattern '<option>Dokter Konsulen</option>' -Description 'consultant physician profession'
Assert-Contains -PathToCheck $monitoringHtml -Pattern '<option>Dokter Umum</option>' -Description 'general physician profession'
