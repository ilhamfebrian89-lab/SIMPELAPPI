const isolationCategories = [
  {
    id: 'hand-hygiene',
    name: '1. Kebersihan Tangan',
    description: 'Kepatuhan lima momen dan teknik kebersihan tangan.',
    items: [
      'Fasilitas handrub atau wastafel tersedia dan mudah dijangkau',
      'Petugas melakukan kebersihan tangan sebelum kontak pasien',
      'Petugas melakukan kebersihan tangan setelah kontak pasien atau lingkungan',
      'Teknik dan durasi kebersihan tangan sesuai standar'
    ]
  },
  {
    id: 'ppe',
    name: '2. Alat Pelindung Diri',
    description: 'Pemilihan, penggunaan, pelepasan, dan pembuangan APD.',
    items: [
      'APD dipilih sesuai risiko pajanan',
      'APD dikenakan sebelum memasuki area pasien',
      'Urutan pelepasan APD mencegah kontaminasi',
      'APD sekali pakai dibuang pada tempat yang sesuai'
    ]
  },
  {
    id: 'patient-placement',
    name: '3. Penempatan Pasien',
    description: 'Penempatan pasien sesuai risiko transmisi dan kapasitas ruang.',
    items: [
      'Kebutuhan isolasi dinilai saat pasien masuk',
      'Pasien ditempatkan di ruang isolasi atau kohort yang sesuai',
      'Jarak antartempat tidur memenuhi ketentuan',
      'Pintu dan ventilasi ruang dikelola sesuai jenis isolasi'
    ]
  },
  {
    id: 'respiratory-hygiene',
    name: '4. Kebersihan Pernapasan dan Etika Batuk',
    description: 'Penerapan etika batuk untuk pasien, pendamping, dan petugas.',
    items: [
      'Poster etika batuk tersedia pada area pelayanan',
      'Masker dan tisu tersedia bagi pasien bergejala',
      'Pasien dan pendamping mendapat edukasi etika batuk',
      'Limbah tisu atau masker dibuang dengan benar'
    ]
  },
  {
    id: 'safe-injection',
    name: '5. Praktik Injeksi Aman',
    description: 'Keamanan penyiapan dan pemberian obat injeksi.',
    items: [
      'Obat disiapkan pada area bersih',
      'Jarum dan spuit digunakan hanya untuk satu pasien',
      'Vial dosis tunggal tidak digunakan bersama',
      'Asepsis dipertahankan selama penyiapan dan pemberian'
    ]
  },
  {
    id: 'equipment',
    name: '6. Dekontaminasi Peralatan Pasien',
    description: 'Pembersihan dan dekontaminasi peralatan setelah digunakan.',
    items: [
      'Peralatan kritis, semi kritis, dan nonkritis dipisahkan',
      'Peralatan reusable dibersihkan sesuai SOP',
      'Peralatan khusus pasien tidak digunakan silang tanpa dekontaminasi',
      'Proses dekontaminasi terdokumentasi'
    ]
  },
  {
    id: 'environment',
    name: '7. Pengendalian Lingkungan',
    description: 'Kebersihan permukaan dan lingkungan ruang isolasi.',
    items: [
      'Jadwal pembersihan rutin tersedia',
      'Permukaan high-touch dibersihkan dengan frekuensi yang sesuai',
      'Bahan dan konsentrasi disinfektan sesuai SOP',
      'Pembersihan terminal dilakukan setelah pasien keluar'
    ]
  },
  {
    id: 'linen',
    name: '8. Pengelolaan Linen',
    description: 'Penanganan linen bersih dan linen terkontaminasi.',
    items: [
      'Linen kotor tidak dikibaskan',
      'Linen infeksius dimasukkan ke kantong berlabel',
      'Linen bersih dan kotor disimpan terpisah',
      'Transportasi linen menggunakan wadah tertutup'
    ]
  },
  {
    id: 'waste',
    name: '9. Pengelolaan Limbah',
    description: 'Pemilahan, penyimpanan, dan pengangkutan limbah.',
    items: [
      'Limbah dipilah pada sumbernya',
      'Wadah limbah sesuai kode warna dan berlabel',
      'Wadah tidak diisi melebihi batas aman',
      'Pengangkutan limbah menggunakan jalur dan alat yang ditetapkan'
    ]
  },
  {
    id: 'sharps',
    name: '10. Pencegahan Pajanan Benda Tajam',
    description: 'Pencegahan luka tusuk dan penanganan pajanan.',
    items: [
      'Safety box tersedia dekat titik tindakan',
      'Jarum tidak ditutup ulang setelah digunakan',
      'Safety box diganti sebelum melewati batas isi',
      'Alur pelaporan pajanan diketahui oleh petugas'
    ]
  },
  {
    id: 'contact',
    name: '11. Kewaspadaan Transmisi Kontak',
    description: 'Pencegahan penularan melalui kontak langsung dan tidak langsung.',
    items: [
      'Tanda kewaspadaan kontak terpasang',
      'Sarung tangan dan gaun digunakan sesuai indikasi',
      'Peralatan didedikasikan untuk satu pasien',
      'Kebersihan tangan dilakukan saat keluar ruang pasien'
    ]
  },
  {
    id: 'droplet',
    name: '12. Kewaspadaan Transmisi Droplet',
    description: 'Pencegahan penularan melalui percikan saluran pernapasan.',
    items: [
      'Tanda kewaspadaan droplet terpasang',
      'Masker medis digunakan saat berada dekat pasien',
      'Pasien menggunakan masker saat transportasi',
      'Pengunjung menerima instruksi sebelum masuk'
    ]
  },
  {
    id: 'airborne',
    name: '13. Kewaspadaan Transmisi Airborne',
    description: 'Pencegahan penularan melalui partikel udara.',
    items: [
      'Tanda kewaspadaan airborne terpasang',
      'Respirator N95 digunakan dan diperiksa kerapatannya',
      'Pasien ditempatkan pada ruang bertekanan negatif bila tersedia',
      'Pintu ruang pasien selalu tertutup'
    ]
  },
  {
    id: 'transport',
    name: '14. Transportasi Pasien Infeksius',
    description: 'Pengendalian risiko selama pemindahan pasien.',
    items: [
      'Transportasi dibatasi pada kebutuhan klinis',
      'Unit tujuan diberi informasi sebelum pasien dipindahkan',
      'Pasien menggunakan APD atau masker sesuai indikasi',
      'Kursi roda atau brankar didekontaminasi setelah digunakan'
    ]
  }
];
